  ...
  return (
    ...
    >
      <Link
        ...
        className="group flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-gray-800 dark:bg-gray-900 dark:hover:shadow-gray-900/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500"
        ...
        <div className="flex flex-1 flex-col p-5 gap-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 leading-snug line-clamp-2 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
                {subject.title}
              </h3>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span>
              ~<span className="font-medium text-gray-700 dark:text-gray-300">{subject.estimatedHours}h</span>
            </span>
            <span aria-hidden="true">·</span>
