      ...
      <div className="mx-auto max-w-7xl px-6 py-10 md:py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="space-y-3">
            <Link
              to="/"
              className="inline-flex items-center gap-1.5 text-lg font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 rounded"
            >
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
              A comprehensive interactive curriculum covering everything from RAG
              to Vibe Engineering — your path to becoming an Enterprise Agentic AI Architect.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  href="https://github.com/shankarpandala/Learn-AgenticAI/blob/main/LICENSE"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 transition-colors"
                >
        ...
        <div className="mt-8 border-t border-gray-100 pt-6 dark:border-gray-800">
          <p className="text-center text-xs text-gray-400 dark:text-gray-500">
            &copy; {year} Learn-AgenticAI by Shankar Pandala. Released under the MIT License.
