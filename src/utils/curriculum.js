/**
 * Curriculum navigation utilities for Learn-AgenticAI.
...
/**
 * Get subject metadata by its ID string (e.g. '01-rag-fundamentals').
 */
...
/**
 * Count the total number of sections in a subject.
 */
