...
const CURRICULUM = [
    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          {
            id: 's4-cloud-retrieval-services',
            title: 'Cloud-Native Retrieval Services',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: 'Azure AI Search (semantic ranking, integrated vectorization), Bedrock Knowledge Bases (S3 + OpenSearch), and Vertex AI Search (enterprise grounding) as managed RAG backends.',
          },
        ],
      },
      {
    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          {
            id: 's4-cloud-model-catalogs',
            title: 'Cloud Model Catalogs',
            difficulty: 'intermediate',
            readingMinutes: 12,
            description: 'Access frontier models via Azure OpenAI Service, Amazon Bedrock Converse API, and Vertex AI Model Garden — comparing deployment options, SLAs, and compliance certifications.',
          },
        ],
      },
    ],
        ...
        sections: [
          {
            ...
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: 'Azure OpenAI Python SDK and Azure AI Inference SDK: authentication with DefaultAzureCredential/managed identity, streaming, tool use, and async clients.',
          },
          {
            id: 's2-aws-bedrock-sdk',
            title: 'AWS Bedrock SDK',
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: 'boto3 Bedrock runtime client with the unified Converse API: streaming, tool use, Bedrock Agent runtime for invoking managed agents.',
          },
          {
            id: 's3-vertex-ai-sdk',
            title: 'Vertex AI SDK',
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: 'google-cloud-aiplatform SDK: GenerativeModel for Gemini, streaming, function calling, context caching, and grounding with Google Search.',
          },
          {
            id: 's4-litellm',
            title: 'LiteLLM: Unified Cloud Interface',
            difficulty: 'intermediate',
            readingMinutes: 12,
            description: 'LiteLLM as a unified interface across Azure OpenAI, Bedrock, and Vertex AI: proxy server, cost tracking, fallback routing, and model aliasing.',
          },
        ],
      },
    ],
    ...
    chapters: [
      {
        ...
        sections: [
          ...
          {
            id: 's4-managed-agent-services',
            title: 'Managed Agent Services',
            difficulty: 'advanced',
            readingMinutes: 14,
            description: 'When to use Azure AI Agent Service vs Bedrock Agents vs Vertex AI Agent Builder vs self-hosted: operational trade-offs, pricing, SLAs, and compliance.',
          },
        ],
      },
      {
    ...
    chapters: [
      ...
      },
      {
        ...
        sections: [
          ...
          {
            id: 's4-cloud-guardrails',
            title: 'Cloud AI Guardrails',
            difficulty: 'advanced',
            readingMinutes: 14,
            description: 'Azure AI Content Safety, Amazon Bedrock Guardrails (PII redaction, grounding check), and Vertex AI safety settings: comparing coverage and layering with application-level validation.',
          },
        ],
      },
      {
  ...
  // ─────────────────────────────────────────────────────────
  // 12 · Cloud AI Platforms for Agentic AI
  // ─────────────────────────────────────────────────────────
  {
    id: '12-cloud-ai-platforms',
    title: 'Cloud AI Platforms',
    icon: '☁️',
    colorHex: '#0ea5e9',
    difficulty: 'intermediate',
    estimatedHours: 40,
    prerequisites: ['03-agent-foundations', '07-sdks-frameworks'],
    description:
      'Master Azure AI, Amazon Bedrock, and Google Vertex AI for building production Agentic AI systems — covering managed LLM services, agent frameworks, RAG backends, and guardrails on each major cloud.',
    chapters: [
      {
        id: 'c1-azure-ai',
        title: 'Azure AI for Agentic Systems',
        sections: [
          {
            id: 's1-azure-openai-service',
            title: 'Azure OpenAI Service',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: 'Deploy GPT-4o, o1, and embedding models on Azure: deployment types (standard, PTU, global), quota management, private endpoints, responsible AI filters, and the Assistants API.',
          },
          {
            id: 's2-azure-ai-foundry',
            title: 'Azure AI Foundry',
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: 'Azure AI Foundry model catalog (Phi-3/4, Llama 3, Mistral, Command R+), Prompt Flow for agent pipelines, AI evaluations, safety evaluations, tracing, and model benchmarks.',
          },
          {
            id: 's3-azure-ai-agent-service',
            title: 'Azure AI Agent Service',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: 'Build production agents on Azure: tool calling (functions, Bing grounding, file search, code interpreter), persistent threads, agent SDK (Python + JavaScript), and pricing.',
          },
          {
            id: 's4-semantic-kernel',
            title: 'Semantic Kernel',
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: "Microsoft's open-source agent SDK: Kernel plugins, function calling, sequential and auto planners, vector memory with Azure AI Search, and multi-agent orchestration patterns.",
          },
        ],
      },
      {
        id: 'c2-aws-ai',
        title: 'Amazon Bedrock & Agentic Services',
        sections: [
          {
            id: 's1-amazon-bedrock',
            title: 'Amazon Bedrock',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: 'Amazon Bedrock model catalog: Claude 3.x, Llama 3, Mistral, Amazon Nova Pro/Lite/Micro, Titan. Unified Converse API, streaming, cross-region inference, on-demand vs provisioned throughput.',
          },
          {
            id: 's2-bedrock-agents',
            title: 'Amazon Bedrock Agents',
            difficulty: 'intermediate',
            readingMinutes: 16,
            description: 'Build managed agents on Bedrock: action groups (Lambda-backed tools), knowledge bases (managed RAG with S3 + OpenSearch/Aurora), agent aliases and versioning, and multi-agent collaboration.',
          },
          {
            id: 's3-bedrock-guardrails',
            title: 'Amazon Bedrock Guardrails',
            difficulty: 'intermediate',
            readingMinutes: 12,
            description: 'Apply Bedrock Guardrails: content filters (hate/violence), denied topics, PII redaction (13 entity types), grounding check for hallucination detection, and word filters across all models.',
          },
          {
            id: 's4-amazon-q-developer',
            title: 'Amazon Q Developer',
            difficulty: 'intermediate',
            readingMinutes: 12,
            description: "Amazon Q Developer's agentic features: /dev for multi-file feature implementation, automated code reviews, security vulnerability scans, unit test generation, and Java upgrade transformations.",
          },
        ],
      },
      {
        id: 'c3-gcp-ai',
        title: 'Google Cloud Vertex AI & Gemini',
        sections: [
          {
            id: 's1-vertex-ai-gemini',
            title: 'Vertex AI + Gemini',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: 'Gemini 2.0 Flash/Pro on Vertex AI: multimodal inputs (text, image, video, audio, PDF), 1M token context window, grounding with Google Search, system instructions, and the Vertex AI SDK.',
          },
          {
            id: 's2-vertex-ai-agent-builder',
            title: 'Vertex AI Agent Builder',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: 'Build agents on GCP: data stores (RAG over Cloud Storage, BigQuery, websites), playbooks for conversation flows, tool integrations, agent evaluation, and Dialogflow CX integration.',
          },
          {
            id: 's3-google-adk',
            title: 'Google Agent Development Kit (ADK)',
            difficulty: 'intermediate',
            readingMinutes: 15,
            description: "Google's open-source Python/Java multi-agent framework: built-in tools (Google Search, code execution), sequential/parallel/loop agent patterns, Agent Engine deployment, and eval framework.",
          },
          {
            id: 's4-model-garden',
            ...
            difficulty: 'intermediate',
            readingMinutes: 12,
            description: 'Access and fine-tune open models on Vertex: Llama 3.1/3.3, Mistral, Gemma 2, Claude on Vertex. Supervised fine-tuning, model evaluation, and Vertex AI Pipelines for MLOps.',
          },
        ],
      },
      {
        id: 'c4-cross-cloud',
        title: 'Cross-Cloud Architecture Patterns',
        sections: [
          {
            id: 's1-model-selection-across-clouds',
            title: 'Choosing Cloud Models',
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: 'Latency/cost/capability matrix across Azure OpenAI, Bedrock, and Vertex AI; data residency and compliance constraints; PTU vs on-demand vs committed pricing models.',
          },
          {
            id: 's2-multi-cloud-agents',
            title: 'Multi-Cloud Agent Architecture',
            difficulty: 'advanced',
            readingMinutes: 14,
            description: 'Route between Azure/AWS/GCP based on cost, latency, and compliance. Failover patterns, LiteLLM as abstraction layer, vendor lock-in mitigation, and multi-cloud observability.',
          },
          {
            id: 's3-cloud-native-rag',
            title: 'Cloud-Native RAG Patterns',
            difficulty: 'intermediate',
            readingMinutes: 14,
            description: 'Azure AI Search + Azure OpenAI vs Bedrock Knowledge Bases vs Vertex AI Search: managed vs self-hosted trade-offs, hybrid search, integrated vectorization, and grounding patterns.',
          },
        ],
      },
    ],
