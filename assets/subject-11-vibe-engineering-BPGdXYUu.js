...
- If you can't fix a finding safely, escalate to the engineer`}),e.jsx(l,{title:"Security Scanner MCP Server",tabs:[{label:"python",language:"python",filename:"mcp_servers/security_scanner.py",code:`# mcp_servers/security_scanner.py
import subprocess
import json
