...
Code interpreter       | Yes (Assistants API)    | No (use tool)             | Yes (code execution)`}),e.jsx("h2",{children:"Decision Flowchart"}),e.jsx(s,{title:"Model Selection Decision Flow",width:720,height:360,nodes:[{id:"start",label:`Workload
