import{j as e}from"./vendor-1_4fyI-O.js";import{C as v,a as u,N as C,B as k}from"./subject-01-rag-fundamentals-DGDd0J9G.js";import{P as w}from"./subject-03-agent-foundations-BlYtBlBv.js";const R={agent:{fill:"#e0f2fe",stroke:"#0284c7",textFill:"#0c4a6e"},tool:{fill:"#f0fdf4",stroke:"#16a34a",textFill:"#14532d"},store:{fill:"#faf5ff",stroke:"#7c3aed",textFill:"#4c1d95"},external:{fill:"#fff7ed",stroke:"#ea580c",textFill:"#7c2d12"},llm:{fill:"#fdf4ff",stroke:"#a21caf",textFill:"#701a75"},default:{fill:"#f8fafc",stroke:"#64748b",textFill:"#1e293b"}},S={agent:{fill:"#0c4a6e",stroke:"#38bdf8",textFill:"#e0f2fe"},tool:{fill:"#14532d",stroke:"#4ade80",textFill:"#dcfce7"},store:{fill:"#4c1d95",stroke:"#c084fc",textFill:"#ede9fe"},external:{fill:"#7c2d12",stroke:"#fb923c",textFill:"#fff7ed"},llm:{fill:"#701a75",stroke:"#e879f9",textFill:"#fdf4ff"},default:{fill:"#1e293b",stroke:"#94a3b8",textFill:"#e2e8f0"}};function I(r,o,n){if(r.filter(i=>i.x!==void 0&&i.y!==void 0).length===r.length)return r;const t=Math.ceil(Math.sqrt(r.length)),l=o/(t+1),h=n/(Math.ceil(r.length/t)+1);return r.map((i,d)=>({...i,x:i.x??l*(d%t+1),y:i.y??h*(Math.floor(d/t)+1)}))}function A({nodes:r=[],edges:o=[],width:n=640,height:a=320,title:t,dark:l=!1}){const h=I(r,n,a),i=Object.fromEntries(h.map(s=>[s.id,s])),d=l?S:R,p=120,m=40,T=8;return e.jsxs("figure",{className:"my-6 overflow-x-auto rounded-xl border border-gray-200 bg-white dark:border-gray-700/60 dark:bg-gray-900",children:[t&&e.jsx("figcaption",{className:"border-b border-gray-100 px-4 py-2 text-xs font-medium text-gray-500 dark:border-gray-800 dark:text-gray-400",children:t}),e.jsxs("svg",{viewBox:`0 0 ${n} ${a}`,width:"100%",style:{maxWidth:n,display:"block",margin:"0 auto"},"aria-label":t??"Architecture diagram",role:"img",children:[e.jsx("defs",{children:e.jsx("marker",{id:"arrowhead",markerWidth:"8",markerHeight:"6",refX:"8",refY:"3",orient:"auto",children:e.jsx("polygon",{points:"0 0, 8 3, 0 6",fill:l?"#94a3b8":"#64748b"})})}),o.map((s,c)=>{const x=i[s.from],g=i[s.to];if(!x||!g)return null;const f=x.x,j=x.y,y=g.x,b=g.y,_=(f+y)/2,P=(j+b)/2;return e.jsxs("g",{children:[e.jsx("line",{x1:f,y1:j,x2:y,y2:b,stroke:l?"#475569":"#94a3b8",strokeWidth:"1.5",markerEnd:"url(#arrowhead)"}),s.label&&e.jsx("text",{x:_,y:P-5,textAnchor:"middle",fontSize:"10",fill:l?"#94a3b8":"#64748b",children:s.label})]},c)}),h.map(s=>{const c=d[s.type??"default"]??d.default;return e.jsxs("g",{transform:`translate(${s.x-p/2}, ${s.y-m/2})`,children:[e.jsx("rect",{width:p,height:m,rx:T,fill:c.fill,stroke:c.stroke,strokeWidth:"1.5"}),e.jsx("text",{x:p/2,y:m/2+4,textAnchor:"middle",fontSize:"11",fontWeight:"500",fill:c.textFill,children:s.label})]},s.id)})]})]})}const N=[{id:"user",label:"User Input",type:"external",x:60,y:150},{id:"claude",label:"Claude Model",type:"llm",x:220,y:150},{id:"tools",label:"Tool Selection",type:"agent",x:380,y:150},{id:"read",label:"Read/Glob/Grep",type:"tool",x:540,y:80},{id:"bash",label:"Bash/Write",type:"tool",x:540,y:150},{id:"git",label:"Git Operations",type:"tool",x:540,y:220},{id:"result",label:"Tool Results",type:"store",x:380,y:280}],E=[{from:"user",to:"claude",label:"prompt"},{from:"claude",to:"tools",label:"plan"},{from:"tools",to:"read",label:"invoke"},{from:"tools",to:"bash",label:"invoke"},{from:"tools",to:"git",label:"invoke"},{from:"read",to:"result",label:"output"},{from:"bash",to:"result",label:"output"},{from:"git",to:"result",label:"output"},{from:"result",to:"claude",label:"observe"}];function J(){return e.jsxs("div",{className:"section-content",children:[e.jsx("h1",{children:"Claude Code Architecture"}),e.jsxs("p",{children:["Claude Code is Anthropic's agentic AI coding assistant that runs directly in your terminal. Unlike browser-based AI tools, Claude Code operates with ",e.jsx("strong",{children:"full filesystem access"}),": it reads and writes files, executes shell commands, searches code with grep and glob patterns, manages git history, and even spawns parallel sub-agents to tackle independent subtasks concurrently. The model behind Claude Code is ",e.jsx("code",{children:"claude-opus-4-6"}),", optimized for long-horizon reasoning over large codebases."]}),e.jsxs("p",{children:["The key architectural insight is that Claude Code is not a chatbot with file-upload support. It is a full ",e.jsx("em",{children:"agent"}),": a model embedded inside a tool-execution loop that repeats until the task is complete or the model decides it is done. Understanding that loop is the foundation for using Claude Code effectively."]}),e.jsx("h2",{children:"The Agent Loop"}),e.jsx(A,{nodes:N,edges:E,width:640,height:320,title:"Claude Code Agent Loop"}),e.jsxs(v,{title:"Agentic Loop",children:[e.jsx("p",{children:"Every action Claude Code takes passes through a four-phase cycle that repeats until the task is complete:"}),e.jsxs("ol",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Perceive"})," — Read files, run shell commands, grep source trees, fetch web pages. The model builds a working picture of the codebase and environment."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Reason"}),' — Given the current context (conversation history + all tool results so far), plan the single best next action. Claude Code thinks in terms of sub-goals: "I need to understand the failing test before I touch the implementation."']}),e.jsxs("li",{children:[e.jsx("strong",{children:"Act"})," — Invoke a tool. Each tool call is atomic: Read a file, run a bash command, write a new file, perform a targeted Edit. Tool calls are sequential by default; sub-agents enable parallelism."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Observe"})," — Receive the tool result and fold it back into context. A failed bash command, a linter warning, or a 200 OK from a test run all become inputs that steer the next planning step."]})]}),e.jsx("p",{children:"The loop terminates when the model emits a plain text response without a tool call, signalling that the task is complete (or that it needs clarification from the user)."})]}),e.jsx("h2",{children:"Installation and Basic Usage"}),e.jsxs("p",{children:["Claude Code is distributed as an npm package and requires Node 18+. After installation, run ",e.jsx("code",{children:"claude"})," inside any project directory."]}),e.jsx(u,{language:"bash",children:`npm install -g @anthropic-ai/claude-code
# Run in your project
claude
# Or with a task
